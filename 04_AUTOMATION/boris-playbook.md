...
**Output:** Archivo `03_WEEKLY/2026/W[XX]-[fecha-lunes].md`

**Pasos:**
1. Abrir VS Code en este repo
2. Abrir una nueva conversación con Claude Code
3. Pegar el contenido del prompt `04_AUTOMATION/prompts/compile-weekly-status.md`
...
6. Guardar el reporte en `03_WEEKLY/2026/`
...
2. Pegar el prompt `04_AUTOMATION/prompts/draft-meeting-agenda.md`
...
**Duración:** ~15 minutos  
**Output:** Entradas nuevas en `02_OPERATIONS/_GLOBAL/weekly-decisions-log.md`
...
3. Pegar el prompt `04_AUTOMATION/prompts/generate-decision-log.md`
4. Pegar las notas crudas donde indica el prompt
5. Revisar el output formateado
6. Appendear al decisions log
7. Actualizar el índice en `03_WEEKLY/decisions-index.md`
...
Este output ya está integrado en el reporte semanal (sección Operations BRA). No requiere un paso separado — Claude lo extrae del STATUS.md de `02_OPERATIONS/BRA/operations/`.
...
2. Abrir VS Code, nueva conversación con Claude Code
3. Instrucción: "Lee todos los archivos kpis.md en 02_OPERATIONS/ARG/ y 02_OPERATIONS/BRA/. Para cada mercado, genera un párrafo de 5-7 líneas que describa el estado operacional del mes, destacando los KPIs más relevantes y señalando los que están fuera de meta. Tono: directo, ejecutivo, en español."
