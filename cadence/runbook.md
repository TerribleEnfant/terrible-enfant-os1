...
**Output:** Archivo `cadence/weekly/2026/W[XX]-[fecha-lunes].md`

**Pasos:**
1. Abrir VS Code en este repo
2. Abrir una nueva conversación con Claude Code
3. Pegar el contenido del prompt `capabilities/workflows/WF_OPS_COMPILE.md`
...
6. Guardar el reporte en `cadence/weekly/2026/`
...
2. Pegar el prompt `capabilities/workflows/WF_OPS_AGENDA.md`
...
**Duración:** ~15 minutos  
**Output:** Entradas nuevas en `cadence/decision_log.md`
...
3. Pegar el prompt `capabilities/workflows/WF_OPS_DECISIONS.md`
4. Pegar las notas crudas donde indica el prompt
5. Revisar el output formateado
6. Appendear al decisions log
7. Actualizar el índice en `cadence/weekly/decisions-index.md`
...
Este output ya está integrado en el reporte semanal (sección Operations BRA). No requiere un paso separado — Claude lo extrae del STATUS.md de `cadence/operations/BRA/operations/`.
...
2. Abrir VS Code, nueva conversación con Claude Code
3. Instrucción: "Lee todos los archivos kpis.md en cadence/operations/ARG/ y cadence/operations/BRA/. Para cada mercado, genera un párrafo de 5-7 líneas que describa el estado operacional del mes, destacando los KPIs más relevantes y señalando los que están fuera de meta. Tono: directo, ejecutivo, en español."
