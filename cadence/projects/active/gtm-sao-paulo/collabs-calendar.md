# Calendario de collabs BR 2026

**Última actualización:** 2026-06-01

> ⚠️ **Conflicto de datos no resuelto.** El documento GTM y el repo traen calendarios distintos. Se muestran ambos. Decidir en reunión cuál es la verdad.

---

## Versión documento GTM (fechado 2 jun 2026)

| Mes | Collab | Estado | Etapa funnel |
|-----|--------|--------|--------------|
...
## Diferencias a reconciliar

- **NOTTHESAMO:** marzo (repo) vs agosto (GTM doc).
- **Edgar:** mayo (repo) vs septiembre (GTM doc).
- **Selo Risco:** julio (repo) vs noviembre (GTM doc).
